            ...
            <div style={{display:"flex",gap:10,marginTop:12}}>
              {[
                ...
                <a key={k} href={url} target="_blank" rel="noreferrer"
                  style={{width:36,height:36,background:"rgba(255,255,255,.08)",border:`1px solid ${C.border}`,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",textDecoration:"none",transition:"background .2s"}}
